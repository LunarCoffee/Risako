...
package bot.exts.commands.`fun`

import bot.consts.Emoji
import bot.exts.commands.`fun`.eightball.EightBallSender
import bot.exts.commands.`fun`.flip.CoinFlipSender
import bot.exts.commands.`fun`.msp.MinesweeperGenerator
import bot.exts.commands.`fun`.roll.*
import bot.exts.commands.`fun`.rplace.RPlaceCanvas

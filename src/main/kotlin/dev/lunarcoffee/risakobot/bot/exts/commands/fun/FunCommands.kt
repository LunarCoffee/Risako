...
package dev.lunarcoffee.risakobot.bot.exts.commands.`fun`

import dev.lunarcoffee.risakobot.bot.consts.Emoji
import dev.lunarcoffee.risakobot.bot.exts.commands.`fun`.eightball.EightBallSender
import dev.lunarcoffee.risakobot.bot.exts.commands.`fun`.flip.CoinFlipSender
import dev.lunarcoffee.risakobot.bot.exts.commands.`fun`.msp.MinesweeperGenerator
import dev.lunarcoffee.risakobot.bot.exts.commands.`fun`.roll.*
import dev.lunarcoffee.risakobot.bot.exts.commands.`fun`.rplace.RPlaceCanvas

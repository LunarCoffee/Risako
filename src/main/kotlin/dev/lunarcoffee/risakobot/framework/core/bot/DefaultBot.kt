...
import dev.lunarcoffee.risakobot.framework.core.bot.config.DefaultConfig
import dev.lunarcoffee.risakobot.framework.core.bot.loaders.CommandLoader
import dev.lunarcoffee.risakobot.framework.core.bot.loaders.ListenerLoader
...
import dev.lunarcoffee.risakobot.framework.core.dispatchers.GuildDispatcher
import dev.lunarcoffee.risakobot.framework.core.dispatchers.parsers.DefaultArgParser
import dev.lunarcoffee.risakobot.framework.core.services.paginators.PaginationReactionListener
import dev.lunarcoffee.risakobot.framework.core.services.reloaders.ReloaderListener
...
internal open class DefaultBot(configPath: String) : Bot {
    ...
    init {
        ...
        jda.addEventListener(
            *listeners.toTypedArray(),              // User-defined [ListenerAdapter] classes.
            PaginationReactionListener,             // Switches paginator pages from reactions.
            WaitList,                               // Allows waiting for a user response.
            ReloaderListener(config.sourceRootDir)  // Reloads things like reminders and unmutes.
        )
